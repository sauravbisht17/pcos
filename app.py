...
from pcosdiagnosis.pipeline.training_pipeline import TrainingPipeline
...
from pcosdiagnosis.constant.training_pipeline import DATA_INGESTION_COLLECTION_NAME
from pcosdiagnosis.constant.training_pipeline import DATA_INGESTION_DATABASE_NAME
